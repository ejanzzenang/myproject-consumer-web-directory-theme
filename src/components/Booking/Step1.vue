        ...
        <div class="row">
          <div class="col-lg-7">
            ...
            <div class="row form-block flex-column flex-sm-row">
              ...
              <div class="col text-center text-sm-right"><router-link to="booking/step2" class="btn btn-primary px-3">
              ...
              <div class="card-body p-4">
                <div class="text-block pb-3">
                  <div class="media align-items-center">
                    ...
                    </div><a href="detail-rooms.html"><img src="img/photo/photo-1512917774080-9991f1c4c750.jpg" alt="" width="100" class="ml-3 rounded"></a>
                  </div>
                </div>
