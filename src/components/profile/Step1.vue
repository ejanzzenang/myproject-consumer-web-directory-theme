              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="custom-control custom-radio">
                    <input type="radio" id="gender_0" name="gender" class="custom-control-input">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="custom-control custom-radio">
                    <input type="radio" id="locality_2" name="locality" class="custom-control-input">
                    <label for="locality_2" class="custom-control-label">Non-Aklanon</label>
                  </div>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="custom-control custom-radio">
                    <input type="radio" id="gender_0" name="gender" class="custom-control-input">
                    <label for="gender_0" class="custom-control-label">Senior Citizen</label>
                  </div>
                  <div class="custom-control custom-radio">
                    <input type="radio" id="gender_1" name="gender" class="custom-control-input">
                    <label for="gender_1" class="custom-control-label">Child of 12 Years Old or Below</label>
                  </div>
                  </div>
                </div>
              </div>
